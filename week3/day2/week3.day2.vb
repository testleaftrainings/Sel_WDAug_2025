...
11:30 to 11:45 ---> Implicit wait&Java wait
11:45 to 12:45 --->Collection-List
12:45 to 1:00 --->Breakout
...
Implicit wait:
1)is an global wait---applies to all the lines of code in the testscript
2)it will not wait for the entire time you have specified
3)after the reaching the max.limit if the elemnt is not found,throws no such element exception

Thread.sleep:
1)it is applicable for the single piece of code.
2)it sleeps for the entire duration whisch is specified.
